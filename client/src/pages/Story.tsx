...
const DecorativeSparkle = memo(
  ({ delay, left, top }: { delay: number; left: string; top: string }) => (
    <motion.div
  ...
  const sortedStory = [
    {
      ...
      content:
        "From the moment our eyes met, I knew there was something extraordinary about you. Time seemed to stand still, and in that instant, everything changed.",
      imageUrl: "https://ik.imagekit.io/xk9ccrlkg/6091345305111563455_121.jpg",
      order: 1,
    },
    {
      id: 2,
      ...
      content:
        "Every conversation, every shared laugh, every quiet moment together brought us closer. I found myself looking forward to seeing you, thinking about you constantly.",
      imageUrl: "https://ik.imagekit.io/xk9ccrlkg/6091345305111563459_121.jpg",
      order: 2,
    },
    {
      id: 3,
      ...
      content:
        "Somewhere along the way, friendship blossomed into something more. My heart would race at the sound of your voice, and your smile became my favorite sight.",
      imageUrl: "https://ik.imagekit.io/xk9ccrlkg/6091345305111563462_121.jpg",
      order: 3,
    },
  ];
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header
          ref={headerRef}
          className="text-center py-12 sm:py-16 md:py-24 px-4 relative"
        >
          ...
          >
            ...
            >
              Every moment with you is a favorite memory waiting to be cherished
              forever.
            </motion.p>
          </motion.div>
