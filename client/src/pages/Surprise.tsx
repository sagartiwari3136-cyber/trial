...
export default function Surprise() {
  ...
  const surpriseText =
    "You are the best gift I could ever ask for so here's a small gift for you!";
  const text = "";
          ...
          {!isOpen ? (
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  backgroundImage:
                    "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 30m-20 0a20 20 0 1 0 40 0a20 20 0 1 0 -40 0' fill='%23ff69b4' fill-opacity='0.4'/%3E%3C/svg%3E\")",
              ...
              <motion.div
                ...
                className="space-y-6 mb-6 relative z-10"
              >
                <p className="text-lg md:text-xl text-gray-700 leading-relaxed font-body px-4">
                  {surpriseText}
                </p>
                <p className="text-sm text-gray-400 italic px-4">({text})</p>
              </motion.div>
              ...
              >
                <img
                  src="https://ik.imagekit.io/xk9ccrlkg/6091345305111563482_119.jpg" // Replace with your image path
                  alt="Our Memory"
                  className="w-40 h-40 md:w-48 md:h-48 object-cover rounded-2xl shadow-xl border-4 border-pink-200"
                />
              </motion.div>
